...
echo -e "\e[1;31m2) Installing simpleadmin from the $GITTREE branch\e[0m"
			...
			mkdir $SIMPLE_ADMIN_DIR/www/js/i18n
			mkdir $SIMPLE_ADMIN_DIR/www/js
			...
			wget $GITROOT/simpleadmin/console/menu/start_menu.sh
			chmod +x $SIMPLE_ADMIN_DIR/console/menu/LAN_settings.sh
			sleep 1
			cd $SIMPLE_ADMIN_DIR/console/services/systemd
			wget $GITROOT/simpleadmin/console/services/systemd/simpleadmin_generate_status.service
			wget $GITROOT/simpleadmin/console/services/systemd/simpleadmin_httpd.service
			wget $GITROOT/simpleadmin/console/services/systemd/ttyd.service
			wget $GITROOT/simpleadmin/console/services/systemd/simpleadmin_generate_status.service
			wget $GITROOT/simpleadmin/console/services/systemd/simpleadmin_httpd.service
			wget $GITROOT/simpleadmin/console/services/systemd/ttyd.service
			chmod +x $SIMPLE_ADMIN_DIR/console/services/systemd/simpleadmin_generate_status.service
			chmod +x $SIMPLE_ADMIN_DIR/console/services/systemd/simpleadmin_httpd.service
			chmod +x $SIMPLE_ADMIN_DIR/console/services/systemd/ttyd.service
			sleep 1
			...
			cd $SIMPLE_ADMIN_DIR/www/js/i18n
			wget $GITROOT/simpleadmin/www/js/i18n/en.js
			wget $GITROOT/simpleadmin/www/js/i18n/zh.js
			wget $GITROOT/simpleadmin/www/js/i18n/language-manager.js
    		sleep 1
